...
| `agent-explorer.tsx` | All sixteen adapters: install route, forwarded env, `--allow` domains, and the per-agent gotcha. |
...
- `agents.ts` — the sixteen adapters, delivery, sizes, forwarded env, baseline domains
