...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    expect:
      "Claude Code starts, with a status line showing the container's memory and CPU. Sixteen agents have a wrapper; four are baked into the image and the rest install themselves on first use.",
  },
  {
...
export const CHALLENGES: Challenge[] = [
  ...
  },
  {
    ...
    cause:
      "Twelve of the sixteen agents are not baked into the image — they install themselves into the persisted HOME on first use, which keeps hundreds of megabytes of adapters you will never run out of the image. That install needs the vendor's download host reachable at that moment.",
