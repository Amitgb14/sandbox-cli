...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    group: "boundary",
    flag: "--runtime",
    body: "Point a run at any OCI runtime the daemon knows: kata-runtime for a microVM with its own kernel, runsc for gVisor's userspace syscall filter. Mounts, hardening, allowlist, caches and secrets all work unchanged on top. Opt-in under dev and required under prod, wherever the engine can register one — prod refuses a shared kernel it did not have to accept.",
