...
Aider, Copilot CLI, Cursor, Qwen, Amp, Continue, OpenHands, Droid, Devin) — or any
...
| [Agent reference](docs/AGENTS.md) | All 16 agents, their prerequisites and login flows |
